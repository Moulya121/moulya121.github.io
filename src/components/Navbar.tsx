...
//               {['overview', 'skills', 'projects', 'experience', 'activities'].map((item) => (
//                 <motion.button
//                   key={item}
...
//           >
//             {item === 'overview' ? 'About Me' : item.charAt(0).toUpperCase() + item.slice(1)}
//           </button>
//         ))}
//       </div>
//     </motion.div>
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex items-center justify-between h-16 w-full">
          {/* Brand Name */}
          <button
            className="text-white text-xl font-bold select-none cursor-pointer bg-transparent border-none p-0"
            onClick={() => scrollToSection('hero')}
            aria-label="Scroll to top"
          >
            Moulya
